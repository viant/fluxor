...
type Input struct {
	Host         *system.Host      `description:"host to execute command on"  internal:"true" json:"host,omitempty"`                                               //host to execute command on
	...
	TimeoutMs    int               `json:"timeoutMs" yaml:"timeoutMs" description:"max wiat time before timing out command"`
